...
This system is a project-storyteller system that you can use as a starting point for building your own custom systems. It's similar to Simple World-building, but has examples of creating attributes in code rather than dynamically through the UI.

## Usage

There are two ways to get started: using the Storyteller system generator command or manually renaming and updating files.
...
Before installing this system, you should rename any files that have `project-storyteller` in their filename to use whatever machine-safe name your system needs, such as `adnd2e` if you were building a system for 2nd edition Advanced Dungeons & Dragons. In addition, you should search through the files for `project-storyteller` and `Storyteller` and do the same for those, replacing them with appropriate names for your system.
...
Head over to the [Vue3Storyteller System](https://gitlab.com/asacolips-projects/foundry-mods/vue3project-storyteller) repo if you're interested in using Vue!
